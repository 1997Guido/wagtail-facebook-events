...
from wagtail_facebook_events.api_clients.fake import FakeFacebookEventsAPI

logger = logging.getLogger(__name__)


class FacebookEventsImporterFake(BaseFacebookEventsImporter):
    def __init__(self, full_sync=False):
        self.full_sync = full_sync
        self.events_api = FakeFacebookEventsAPI()
        logger.info(
